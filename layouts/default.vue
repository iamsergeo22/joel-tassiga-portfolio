<template>
  <div class="font-sans flex flex-col">
    <header>
      <nav class="mx-auto flex flex-wrap gap-4 justify-evenly  items-center py-6 shadow mb-2">
        <div>
          <nuxt-link v-if="theme === 'theme-light'" to="/">
            <h1 class="text-xl">
              <span class="text-blue-600">Joel</span><span class="text-blue-600">Tass</span><span
                class="text-black">iga</span>
            </h1>
          </nuxt-link>
          <nuxt-link v-else to="/">
            <h1 class="text-xl">
        ...
        <ul
          ...
          <li>
            <nuxt-link to="/projet" class="text-black hover:text-gray-600 text-xl">Projets</nuxt-link>
          </li>
          <li>
      ...
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          <div class="flex flex-col lg:flex-row gap-2">
            <span>Copyright {{ new Date().getFullYear() }} Joel Tassiga Portfolio's </span>
          </div>
        </div>
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:joetasyoung2014@gmail.com" target="_blank" class="text-black hover:text-gray-400">
          ...
          <li>
            <a href="https://www.instagram.com/joeltassigagram/" target="_blank" class="text-black hover:text-gray-400">
