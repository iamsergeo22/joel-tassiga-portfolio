  ...
  <div class="font-sans flex flex-col">
    <header>
      <nav class="mx-auto flex flex-wrap gap-4 justify-evenly  items-center py-6 shadow mb-2">
        <div>
          <nuxt-link v-if="theme === 'theme-light'" to="/"><h1 class="text-xl">
           <span class="text-blue-600">Joel</span><span class="text-blue-600">Tass</span><span class="text-black">iga</span>
          </h1></nuxt-link>
          <nuxt-link v-else to="/"><h1 class="text-xl">
            <span class="text-blue-600">Joel</span><span class="text-blue-600">Tass</span><span class="text-black">iga</span>
          </h1></nuxt-link>
        </div>
